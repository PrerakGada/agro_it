                  ...
                  child: dropdownvalue == 'Rice'
                      ? Column(
                          children: [
                            DataTable(
                              ...
                              rows: const <DataRow>[
                                ...
                                DataRow(
                                  cells: <DataCell>[
                                    DataCell(
                                        Text('Molybdenum (Mo) water-soluble')),
                                    DataCell(Text('1.00% w/w = 1.22% w/v')),
                                  ],
                                ),
                                DataRow(
                            ...
                            Padding(
                              padding: const EdgeInsets.all(8.0),
                              child: Text(
                                "Best Fertilizer Company : Coromandel International Ltd.",
                                style: TextStyle(
                                  fontSize: 18,
                      ...
                      : dropdownvalue == 'Olive'
                          ? Column(
                              children: [
                                ...
                                Padding(
                                  padding: const EdgeInsets.all(8.0),
                                  child: Text(
                                    "Best Fertilizer Company : National Fertilizers Ltd.",
                                    style: TextStyle(
                                      fontSize: 18,
                                      fontWeight: FontWeight.bold,
                                    ),
                          ...
                          : dropdownvalue == 'Vine'
                                      ...
                                      rows: const <DataRow>[
                                        DataRow(
                                          cells: <DataCell>[
                                            DataCell(Text('Free Amino acids')),
                                            DataCell(
                                                Text('5.00% w/w = 6.20% w/v')),
                                          ],
                                        ),
                                        DataRow(
                                          cells: <DataCell>[
                                            DataCell(
                                                Text('Total Nitrogen (N)')),
                                            DataCell(
                                                Text('1.60% w/w = 1.98% w/v')),
                                          ],
                                        ),
                                        DataRow(
                                          cells: <DataCell>[
                                        ...
                                        DataRow(
                                          cells: <DataCell>[
                                            ...
                                            DataCell(
                                                Text('0.50% w/w = 0.61% w/v')),
                                          ],
                                        ),
                                      ],
                                    ),
                                    Text(
                                      "Best Fertilizer Company : Chambal Fertilizers & Chemicals Ltd.",
                                      style: TextStyle(
                                        fontSize: 18,
                                        fontWeight: FontWeight.bold,
                                      ),
                              ...
                              : dropdownvalue == 'For extensive crops'
                                  ? Column(
                                      children: [
                                        DataTable(
                                          columns: const <DataColumn>[
                                        ...
                                        Padding(
                                          padding: const EdgeInsets.all(8.0),
                                          child: Text(
                                            "Best Fertilizer Company : Rashtriya Chemicals & Fertilizers Ltd.",
                                            style: TextStyle(
                                              fontSize: 18,
                                              fontWeight: FontWeight.bold,
                                            ),
                                      ...
                                      ? Column(
                                          children: [
                                            ...
                                            Padding(
                                              ...
                                              child: Text(
                                                "Best Fertilizer Company : Zuari Agro Chemicals Ltd.",
                                                style: TextStyle(
                                                  fontSize: 18,
                                                  fontWeight: FontWeight.bold,
                                                ),
                                          ...
                                          children: [
                                            ...
                                            Padding(
                                              padding:
                                                  const EdgeInsets.all(8.0),
                                              child: Text(
                                                "Best Fertilixer Company : Gujarat Narmada Valley Fertilizers & Chemicals Ltd.",
                                                style: TextStyle(
                                                  fontSize: 18,
                                                  fontWeight: FontWeight.bold,
                                                ),
